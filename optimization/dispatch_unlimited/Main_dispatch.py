...
Setting.startrun=True
Setting.getcf=False
Setting.dispatch=True
Setting.dispatch_unlimited   = True
...
#Setting.invest_elec=str(sys.argv[6]) # 'baseline','0.6','0.8','1.0'
#Setting.elec=str(sys.argv[9]) # 'baseline','0.6','0.8','1.0'
# Setting.iso ='ISONE'
# Setting.scenario = 'historical'
...
# test years
if Setting.scenario == 'historic':
    Setting.test_year = list(range(2011, 2021))
else:
...
Setting.odir='%s/Results_%s_%s/' % (os.getcwd(),Setting.iso, Setting.demandsce)
